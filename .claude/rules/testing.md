...
- TS output tests (`tests/ts_output.rs`) cover ContainerFormat::Ts, HLS-TS manifest rendering, TS muxer roundtrips, webhook validation, handler routing, and key endpoint — all gated behind `#[cfg(feature = "ts")]`.
